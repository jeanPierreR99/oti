...
function get_table_kit_all(){
    var dataTable = $('#table-kit-all').DataTable();
    dataTable.destroy();
//   $("#table-kit-render").html(fill_all)
  $("#table-kit-all").dataTable({
    //   paging: false,
    // ordering: false,
    // info: false,
  });
  $("#table-kit-all_length").removeClass("dataTables_length")
}

function get_table_eco_lab001(){
    var dataTable = $('#table-kit-all').DataTable();
    dataTable.destroy();
    $("#table-kit-render").html(fill_eco_lab001)
}

function get_table_for_lab001(){
    var dataTable = $('#table-kit-all').DataTable();
    dataTable.destroy();
    $("#table-kit-render").html(fill_for_lab001)
    $("#table-kit-all").dataTable({
        //   paging: false,
        // ordering: false,
        // info: false,
...
const fill_eco_lab001= async ()=>{
    const url = "http://192.168.0.10:3000/api/computers?token=123412341234";

    const data = await fetch(url).then((response)=> response.json()).then(data => {return data.data})

    $("#table-kit-render").html(
        data.map(data =>{
        return `<tr class="hover:bg-gray-100">
...
const fill_for_lab001 =()=>{
return `laboratorio forestal 001`
}